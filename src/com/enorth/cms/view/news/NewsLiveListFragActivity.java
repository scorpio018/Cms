...
//		addView();
	...
	/*private void addView() {
		View view = getLayoutInflater().inflate(R.layout.activity_news_live_list_frag, null);
		LinearLayout menuAndContentLayout = (LinearLayout) findViewById(R.id.menuAndContentLayout);
	...
	private void initTitleText() {
		...
		newsTitleText.setText(R.string.news_live_title_text);
	}
...
//				startActivity(intent);
				startActivityForResult(intent, ParamConst.NEWS_LIVE_LIST_FRAG_ACTIVITY_TO_NEWS_SEARCH_ACTIVITY_REQUEST_CODE);
			}
		};
