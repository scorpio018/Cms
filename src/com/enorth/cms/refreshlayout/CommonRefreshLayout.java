...
public abstract class CommonRefreshLayout {
	/**
	 * 当前状态
	 */
	 ...
	 * 刷新回调接口
	 */
	public CommonOnRefreshListener mListener;
	/**
	...
	public abstract View getChildAt(int num);
...
//			Log.w("updateHandler.handleMessage", "刷新布局,会自动调用onLayout");
	...
	public void setOnRefreshListener(CommonOnRefreshListener listener) {
		mListener = listener;
	}
...
//			pullUpView.clearAnimation();
	 ...
	 * 此方法应该在继承此类并重写dispatchTouchEvent方法时调用此方法
	...
	public boolean dispatchTouchEvent(MotionEvent ev) {
		...
		// 事件分发交给父类
		// TODO 此处需要在继承此类并重写dispatchTouchEvent(MotionEvent)方法时调用下面的助释方法
//		super.dispatchTouchEvent(ev);
	...
	public void autoRefresh() {
		CommonAutoRefreshAndLoadTask task = new CommonAutoRefreshAndLoadTask(this);
		task.execute(20);
	}
