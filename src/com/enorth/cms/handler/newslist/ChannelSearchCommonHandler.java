...
//			CommonListViewAdapter listViewAdapter = new CommonListViewAdapter(items);
			activity.getChannelSearchListViewAdapter().setItems(items);
			activity.getChannelSearchListViewAdapter().notifyDataSetChanged();
//			activity.getChannelListView().setAdapter(listViewAdapter);
			...
			activity.getSearchChannelET().setAdapter(searchChannelFilterAdapter);
			activity.getSearchChannelET().setText("");
			searchChannelFilterAdapter.notifyDataSetChanged();
