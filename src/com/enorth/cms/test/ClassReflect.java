...
import com.enorth.cms.test.bean.Person;
...
public class ClassReflect {
	...
	public static void Demo2() throws ClassNotFoundException {
		...
		class1 = Class.forName("com.scorpio.demo.my.bean.Person");
	...
	public static void Demo6() throws ClassNotFoundException {
		Class<?> class1 = null;
		class1 = Class.forName("com.scorpio.demo.my.bean.SuperMan");
		...
		for (int i = 0; i < interfaces.length; i++) {
			...
			Class<?> c = Class.forName(interfaces[i].getName());
			System.out.println("通过接口类名将对应的接口对象进行反射获取的结果：" + c);
		}
